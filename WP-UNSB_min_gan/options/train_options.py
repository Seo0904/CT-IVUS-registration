...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--val_epoch_freq', type=int, default=10, help='frequency of running validation (epochs)')
        parser.add_argument('--num_val_samples', type=int, default=500, help='number of samples to use for validation')
        parser.add_argument('--save_by_iter', action='store_true', help='whether saves model by iteration')
        parser.add_argument('--continue_train', action='store_true', help='continue training: load the latest model')
        parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        parser.add_argument('--iter_count', type=int, default=0, help='the starting total_iters count, used to resume W&B step correctly')
        ...
        parser.add_argument('--grad_stats_freq', type=int, default=100, help='compute OT gradient stats every N steps (0 = disable)')
