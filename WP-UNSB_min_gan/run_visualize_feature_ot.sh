...
python3 visualize_feature_ot.py \
    --feat_num_seq "${FEAT_NUM_SEQ:-1000}" \
    --ot_num_seq "${OT_NUM_SEQ:-3}" \
    --ot_match_file_B "${EVAL_MATCH_FILE_B:-transformed_cloze_global.npy}" \
    --dataroot "${DATAROOT}" \
    ...
    --seq_ot_normalize "${SEQ_OT_NORMALIZE:-none}" \
