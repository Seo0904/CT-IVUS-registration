...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):
        ...
        # OT スナップショット保存は validation 頻度から独立させる。
        # （val_epoch_freq を大きくして validation/FID を切っても、
        #   seq_ot_snapshot_epoch_interval（既定10）で 0,10,20,... を保存する）
