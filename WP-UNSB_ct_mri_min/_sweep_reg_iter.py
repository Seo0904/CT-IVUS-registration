...
NPZ = sys.argv[1] if len(sys.argv) > 1 else (
    "/workspace/data/experiment_result/WP-UNSB_ct_mri/synthRAD-brain/"
    "20260612_013328/synthRAD_brain_ct2mr_sb_w_otdiv_015_geo_gan/"
    "ot_details/train_epoch0200/ot_0124.npz"
)
...
iters_grid = [50, 100, 150, 200, 300, 400, 500, 1000, 5000]
reg_cands = [1, 5, 10, 30, 50, 100, 200]
