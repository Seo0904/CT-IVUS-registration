...
# 保存先ディレクトリ（絶対パス）
RESULT_DIR="${WORKSPACE_DIR}/data/experiment_result/WP-UNSB_ct_mri_min/synthRAD-${REGION}/${DATE}"
...
WANDB_PROJECT=${WANDB_PROJECT:-WP-UNSB_ct_mri_min}
WANDB_GROUP=${WANDB_GROUP:-synthRAD-${REGION}}
WANDB_TAGS=${WANDB_TAGS:-synthRAD,${REGION},ct2mr,WP-UNSB_ct_mri_min}
...
MAX_VOLUMES=${MAX_VOLUMES:-1}          # 0=全volume, 1=lmda/iter調整用に1volumeだけ使う
...
cmd=(python3 train.py
  ...
  --seq_ot_geo_p 2
  --val_epoch_freq 10000000
  --seq_ot_snapshot_epoch_interval 1000
