...
def get_args():
    ...
    p.add_argument('--output', type=str, default="/workspace/data/preprocessed/bspline_transformed/transformed_cloze_global.npy")
...
def main():
    ...
    data = np.load(args.input)  # (N, T, H, W)
