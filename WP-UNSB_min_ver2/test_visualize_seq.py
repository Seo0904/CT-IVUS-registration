...
def main():
    ...
    parser.add_argument("images_dir", type=Path, nargs='?',
                         default="/workspace/data/experiment_result/WP-UNSB_min_ver2/moving-mnist/20260604_121255/test_results/moving_mnist_seg_paired_sb_wo_GL_w_otdiv_015_cloze_geo/test_best/images"
